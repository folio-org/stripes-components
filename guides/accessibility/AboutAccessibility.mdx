...
See the patterns documentation [Accessible Routing in FOLIO](../patterns/AccessibleRouting.mdx) to implement accessible focus management for your application's routing.
