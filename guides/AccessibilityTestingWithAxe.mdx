...
<Meta title="Automated Accessibility Testing" />
...
Check the list at https://github.com/dequelabs/axe-core/issues  to see if work is being done to correct any prevalent issues. You can turn off rules via configuration steps for the previously mentioned testing tools if necessary.
