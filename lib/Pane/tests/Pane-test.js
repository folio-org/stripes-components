...
import { Pane as Interactor, Input as InputInteractor } from '@folio/stripes-testing';
...
describe('Pane', () => {
  ...
  describe('content width, focus method coverage', () => {
    ...
    const fluidpane3 = Interactor({ id: 'fluidpane3' });
    const input2 = fluidpane2.find(InputInteractor());
    beforeEach(async () => {
      await mountWithContext(
        <Paneset>
