...
const PaneHeaderExample = () => (
  <Paneset>
    ...
    <Pane actionMenuItems={actionMenuItems} firstMenu={firstMenu} lastMenu={lastMenu} defaultWidth="fill" paneTitle="Lorem Ipsum is simply dummy text of the printing and typesetting industry." paneSub="121 results found" onClose={() => {}}>
      Some content..
    </Pane>
  </Paneset>
);
