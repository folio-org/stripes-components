...
describe('Paneset', () => {
  ...
  beforeEach(async () => {
    await mountWithContext(
      <Paneset>
        <Pane defaultWidth="fill" paneTitle="Content">Content</Pane>
        <Pane defaultWidth="100px" paneTitle="Px Size">Pixel Content</Pane>
        <Pane defaultWidth="10%" paneTitle="Percent Size">Percent Content</Pane>
        <Pane defaultWidth="10rem" paneTitle="REM Size">REM Content</Pane>
      </Paneset>
    );
  });
  ...
  describe('paneset only affects pixel-based panes widths on resize', () => {
    ...
    it.only('px pane is adjusted - filter pane not still 100px', async () => {
