...
class PanesetHarness extends React.Component {
  ...
  toggleWidth = () => {
    ...
    () => {
      this.set.current?.resizeToContainer();
    });
  }
  ...
  render() {
    ...
    return (
      <div style={{ width: containerWidth, position: 'relative', height: '500px' }}>
        <Paneset ref={this.set}>
          ...
          <Pane id="resultsPane" defaultWidth="fill">
            ...
            <Button onClick={this.toggleWidth} id="toggle-width">Toggle Width of container</Button>
