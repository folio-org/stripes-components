...
export default () => (
  <div>
    ...
    <Row center="xs">
      <Col className={css.col} xs={10}>
        <Button href="https://roylee0704.github.io/react-flexbox-grid" allowAnchorClick target="_blank" buttonStyle="primary" buttonClass={css.button}>Click here to see more examples</Button>
      </Col>
    </Row>
  </div>
);
