...
describe('CommandList, HasCommand', () => {
  ...
  describe('Rendering', () => {
          ...
          <div data-test-module-outer>
            <fieldset style={{ border: '1px solid #666', padding: '12px' }}>
              ...
              <HasCommand
                ...
                isWithinScope={() => true}
              >
                <div data-test-module-sibling ref={siblingRef}>
    ...
    describe('Globally scoped handler is effective', () => {
      ...
      it('calls the globally scoped handler', async () => {
        await converge(() => scopedHandler.called);
      });
    });
    ...
    describe('Handler active within outer layer', () => {
      ...
      it('calls the top level handler', async () => {
        await converge(() => newHandler.calledOnce);
      });
    });
    ...
    describe('Override Handler active within tree', () => {
      ...
      it('calls the override handler', async () => {
        await converge(() => innerHandler.calledOnce);
      });
    });
    ...
    describe('Newly assigned Handler active within tree', () => {
      ...
      it('calls the assigned handler (save)', async () => {
        await converge(() => innerSaveHandler.called);
      });
    });
    ...
    describe('Newly assigned Handler inactive at outer layer', () => {
      ...
      it('does not call the assigned handler', async () => {
        await converge(() => innerSaveHandler.notCalled);
      });
    });
  });
