  ...
  describe('Rendering', () => {
    ...
    describe('Globally scoped handler is effective', () => {
      beforeEach(async () => {
        ...
        await outerInteractor.trigger('keydown', { ctrlKey: true, metaKey: true, char: 'i', keyCode: 73 });
      });
    ...
    describe('Newly assigned Handler active within tree', () => {
      beforeEach(async () => {
        ...
        await innerInteractor.trigger('keydown', { ctrlKey: true, metaKey: true, char: 's', keyCode: 83 });
      });
    ...
    describe('Newly assigned Handler inactive at outer layer', () => {
      beforeEach(async () => {
        ...
        // Safari equivalent with Mac's Command Key used by the "mod+s" shortcut
        await outerInteractor.trigger('keydown', { keyCode: 91 }); // leftCommand
        await outerInteractor.trigger('keydown', { ctrlKey: true, metaKey: true, char: 's', keyCode: 83 });
      });
