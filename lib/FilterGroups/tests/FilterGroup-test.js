...
import FilterGroupsFifthComponent from '../stories/filterGroupsUsageTest5';
import FilterGroupsSixthComponent from '../stories/filterGroupsUsageTest6';
...
describe.only('Filter Group', () => {
  ...
  describe('render Filter Group Fifth component', () => {
    beforeEach(async () => {
      await mount(
  ...
  describe('render Filter Group Sixth component', () => {
    beforeEach(async () => {
      await mount(
        <FilterGroupsSixthComponent />
      );
    });
