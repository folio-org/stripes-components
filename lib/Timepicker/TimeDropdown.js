...
class TimeDropdown extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.selectedTime !== this.props.selectedTime) {
      ...
      if (moment(nextProps.selectedTime, this.props.timeFormat, true).isValid()) {
        initMoment = moment(nextProps.selectedTime, this.props.timeFormat, true);
      } else if (moment(nextProps.selectedTime, 'hh', true).isValid()) {
        initMoment = moment(nextProps.selectedTime, 'hh', true);
      } else if (moment(nextProps.selectedTime, 'h', true).isValid()) {
        initMoment = moment(nextProps.selectedTime, 'h', true);
      } else {
