...
import { withIntl, FormattedMessage, formattedMessage } from 'react-intl';
...
const propTypes = {
  ...
  intl: PropTypes.shape({
    formattedMessage: PropTypes.func.isRequired
  }).isRequired,
      ...
      >
        ...
        <Row center={this.props.hoursFormat === '12' ? undefined : 'xs'}>
          <Col xs={4}>
            <TextField
              ...
              autoFocus
              aria-label={formattedMessage({ id: 'stripes-components.Timepicker.hoursLabel' })}
          ...
          <Col xs={4}>
            <TextField
              ...
              aria-label={formattedMessage({ id: 'stripes-components.Timepicker.minutesLabel' })}
          ...
          {this.state.hoursFormat === '12' &&
            <Col xs={3}>
              <Button
                aria-label={formattedMessage({ id: 'stripes-components.Timepicker.PeriodLabel' })}
        ...
        <Row>
          <Col xs={12}>
            ...
            <input className="sr-only" aria-label="back to field" onFocus={this.props.onHide} />
          </Col>
        </Row>
      </div>
    );
...
export default withIntl(TimeDropdown);
