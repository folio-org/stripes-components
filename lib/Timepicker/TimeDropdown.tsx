...
const padZero = (value) => {
  ...
  return parseInt(value, 10) < 10 ? `0${value}` : value.toString();
};
...
const TimeDropdown = ({
  ...
  const hoursFormatCharacter = useRef(
    `${hoursFormat === "24" ? "HH" : "h"}`,
  ).current;
  ...
  const [period, setPeriod] = useState(
    deriveDefaultTimePeriod(selectedTime, hoursFormat, timeFormat, dayPeriods),
  );
  ...
  return (
    ...
    >
      <>
        <FocusLink sendOnFocus target={confirmButton.current}>
        ...
        <Row center={hoursFormat === "12" ? undefined : "xs"}>
          ...
          <Col xs={4} className={css.center}>
            <IconButton
              ...
              onClick={() => {
                modifyTime(minuteIncrement, "minute", true);
              }}
            />
          </Col>
        </Row>
        <Row center={hoursFormat === "12" ? undefined : "xs"}>
          ...
          <Col xs={1}>
            <Layout
              className={`display-flex flex-align-items-center ${css.colon}`}
            >
              :
            </Layout>
          </Col>
          ...
          {hoursFormat === "12" && (
            <Col xs={3}>
              <Select
                aria-label={intlContext.formatMessage({
                  id: "stripes-components.Timepicker.PeriodLabel",
                })}
                value={period}
        ...
        <Row center={hoursFormat === "12" ? undefined : "xs"}>
          ...
          <Col xs={4} className={css.center}>
            <IconButton
              ...
              icon="arrow-down"
              onClick={() => {
                modifyTime(minuteIncrement, "minute", false);
              }}
            />
          </Col>
        </Row>
        ...
        <FocusLink sendOnFocus target={hoursInput.current}>
          <span className="sr-only">
