...
import useCrossTabSessionStorage from '../../hooks/useCrossTabSessionStorage';
...
const SessionConfirmationModal = ({ sessionKey, checkboxLabel, onConfirm, open, message, ...rest }) => {
  ...
  const [suppressStorage, setSuppressStorage] = useCrossTabSessionStorage(sessionKeyRef.current, false);
