...
const ConfirmationModal = (props) => {
  ...
  const cancelLabel = props.cancelLabel || formatMessage({ id: 'stripes-components.cancel' });
  const confirmLabel = props.confirmLabel || formatMessage({ id: 'stripes-components.submit' });
