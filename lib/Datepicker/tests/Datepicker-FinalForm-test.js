...
describe('Datepicker with Final Form', () => {
  ...
  describe('clear button', () => {
    ...
    beforeEach(async () => {
      ...
      await mountWithContext(
        <Form
          onSubmit={() => {}}
          initialValues={{ calendar: '04/01/2018' }}
          render={() => (
            <Field
              name="calendar"
              component={Datepicker}
  ...
  describe('dateFormat prop', () => {
    beforeEach(async () => {
      await mountWithContext(
        <Form
          onSubmit={() => {}}
          initialValues={{ calendar: '2018-18-04' }}
          render={() => (
            <Field
              name="calendar"
    ...
    describe('multiple dates', () => {
      beforeEach(async () => {
        await mountWithContext(
          <Form
            onSubmit={() => {}}
            initialValues={{ calendar: '04/05/2018' }}
            render={() => (
              <Field
                name="calendar"
                component={Datepicker}
    ...
    describe('selecting excluded date', () => {
      ...
      beforeEach(async () => {
        ...
        await mountWithContext(
          <Form
            onSubmit={() => {}}
            initialValues={{ calendar: '04/03/2018' }}
            render={() => (
              <Field
                name="calendar"
                component={Datepicker}
