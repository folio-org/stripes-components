...
describe('Datepicker', () => {
  ...
  describe('usePortal functionality', () => {
    ...
    describe('pressing escape', () => {
      ...
      it('closes the picker', () => {
        expect(datepickerOverlayInteractor.$root.children[0].style.display).to.equal('none');
      });
    });
  ...
  describe('focus trapping', () => {
    ...
    describe('focusing back off the first item', () => {
      beforeEach(async () => {
        await datepicker.calendar.startFocusTrap.focusable();
      });
    ...
    describe('focusing forward off the first item', () => {
      beforeEach(async () => {
        await datepicker.calendar.endFocusTrap.focusable();;
      });

      it('shifts focus to previous month button', () => {
        expect(datepicker.calendar.previousMonth.isFocused).to.be.true;
      });
    });
  });
  ...
  describe('calendar widget', () => {
    ...
    describe('advancing the year', () => {
      ...
      describe('previous year', () => {
        beforeEach(async () => {
          await datepicker.calendar.previousYear.click();
        });
    ...
    describe('clicking outside of calendar', () => {
      ...
      it('closes the calendar picker', () => {
        expect(datepicker.calendar.parent.style.display).to.equal('none')
      });
    });
  });
