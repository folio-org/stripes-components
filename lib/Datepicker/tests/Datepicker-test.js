...
describe('Datepicker', () => {
  ...
  describe('focus trapping', () => {
    ...
    describe('focusing back off the first item', () => {
      beforeEach(async () => {
        await datepicker.calendar.startFocusTrap.focus();
      });
    ...
    describe('focusing forward off the first item', () => {
      beforeEach(async () => {
        await datepicker.calendar.endFocusTrap.focus();
        await focusNext(document.activeElement);
      });

      it('shifts focus to previous month button', () => {
        expect(datepicker.calendar.previousMonthButton.isFocused).to.be.true;
      });
    });
  });
