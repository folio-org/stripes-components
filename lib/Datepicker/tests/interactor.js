...
export const previousYearButton = interactor(class PreviousYearButton {
...
export const Calendar = interactor(class Calendar {
  ...
  previousYear = scoped('[data-test-calendar-previous-year]', previousYearButton);
  nextYear = clickable('[data-test-calendar-next-year]');
  startFocusTrap = scoped('[data-test-start-focus-trap]');
  endFocusTrap = scoped('[data-test-end-focus-trap]');
