...
export const NavButton = interactor(class NavButton {
  isFocused = is(':focus');
  click = clickable();
  ...
  pressShiftTab = triggerable('keydown', {
    bubbles: true,
    cancelable: true,
    shiftKey: true,
    keyCode: 9,
...
export const FocusTrap = interactor(class FocusTrap {
  focus = focusable();
});
...
export const Calendar = interactor(class Calendar {
  ...
  previousMonthButton = scoped('[data-test-calendar-previous-month]', NavButton);
  nextMonth = clickable('[data-test-calendar-next-month]');
  nextMonthButton = scoped('[data-test-calendar-next-month]', NavButton);
  previousYear = clickable('[data-test-calendar-previous-year]');
  previousYearButton = scoped('[data-test-calendar-previous-year]', NavButton);
  nextYear = clickable('[data-test-calendar-next-year]');
  previousYearButton = scoped('[data-test-calendar-next-year]', NavButton);
  startFocusTrap = scoped('[data-test-start-focus-trap]', FocusTrap);
  endFocusTrap = scoped('[data-test-end-focus-trap]', FocusTrap);
