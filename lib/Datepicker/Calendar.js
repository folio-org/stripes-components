...
const propTypes = {
  ...
  firstButtonRef: PropTypes.oneOfType([PropTypes.object, PropTypes.func]).isRequired,
  id: PropTypes.string,
...
class Calendar extends React.Component {
  constructor(props) {
    ...
    this.firstButton = props.firstButtonRef;
  ...
  focusTrap = {
    toStart: () => { this.firstButton.current?.focus(); }, // eslint-disable-line no-unused-expressions
    toLast: () => {
      const cursorDaybutton = this.calendarGrid.current?.querySelector('[tabindex="0"]')
      cursorDaybutton.focus(); // eslint-disable-line no-unused-expressions
    }
  }
  ...
  render() {
    ...
    return (
      ...
      >{/* eslint-disable jsx-a11y/no-noninteractive-tabindex */}
        ...
        <div
          data-test-end-focus-trap
          onFocus={this.focusTrap.toStart}
          tabIndex="0"
        />
