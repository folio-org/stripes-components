...
class Calendar extends React.Component {
    ...
    if(this.props.date === '' || this.props.date === 'undefined'){
      ...
      if(moment(this.props.date, this.props.format).isValid()){
        initDate = moment(this.props.date, this.props.format);
        inputDate = moment(this.props.date, this.props.format);
      }else {
        initDate = moment();
        inputDate = moment();
      }
  ...
  setDate(day, e){
    ...
    this.props.onSetDate(e, day, day.format(this.props.format));
  }
      ...
      function(week) {
        ...
        const days = dayList.map(
          function(day){
              ...
              <div onFocus={this.props.buttonFocus} className={ dayClasses } title={'Select ' + day.format('dddd') + ", " + day.format(this.props.format)} onClick={ (e) => this.setDate(day, e) } onKeyDown={this.props.onKeyDown}  onBlur={this.props.onBlur} tabIndex="-1">{ day.format('D') }</div></td>
            }, this
        );
