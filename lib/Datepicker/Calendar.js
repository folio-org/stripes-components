          ...
          <table role="presentation">
            <thead>
              ...
              <tr>
                ...
                <td>
                  <button href="#" className={css.nav} type="button" onClick={this.previousMonth} onKeyDown={this.props.onKeyDown} tabIndex="-1" style={arrowStyle} title="Go to previous month"><Icon icon="back-arrow" /></button>
                </td>
                <td colSpan="3"><span className={css.selectedMonth}>{moment().month(this.state.month).format('MMMM')} {this.state.year}</span></td>
                <td>
                  <button href="#" className={css.nav} type="button" onClick={this.nextMonth} onKeyDown={this.props.onKeyDown} tabIndex="-1" style={arrowStyle} title="Go to next month" ><Icon icon="forward-arrow" /></button>
                </td>
                <td>
