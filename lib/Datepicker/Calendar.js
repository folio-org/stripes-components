      ...
      (week) => {
        ...
        const days = dayList.map(
          (day) => {
            ...
            const excludedAria = isExcluded ? intl.formatMessage({ id: 'stripes-components.Datepicker.unavailable' }) + ' ' : '';
            ...
            return (
              ...
              >
                {ariaLabel => (
                  ...
                  >
                    <div data-excluded={isExcluded ? 'true' : 'false'} className={dayClasses}>
                      {dayString}
                    </div>
                  </td>
                )}
