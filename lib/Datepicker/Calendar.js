      ...
      function(week) {
        ...
        const days = dayList.map(
          function(day){
              ...
              <div onFocus={this.props.buttonFocus} className={ dayClasses } title={'Select ' + day.format('dddd') + ", " + day.format(this.props.dateFormat)} onClick={ (e) => this.setDate(day, e) } onKeyDown={this.props.onKeyDown}  onBlur={this.props.onBlur} tabIndex="-1">{ day.format('D') }</div></td>
            }, this
        );
