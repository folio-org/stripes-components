    ...
    if (this.picker) {
      ...
      switch (e.keyCode) {
        ...
        case 13: // enter
          ...
          dateString = this.context.intl.formatMessage({ id: 'stripes-components.dateSelected' }, { date: formattedDate });
          break;
        case 9: // tab
          this.hideCalendar();
          break;
      ...
      endElement = (
        <div style={{ display: 'flex' }}>
          <Button
            ...
            aria-label={formatMsg({ id: 'stripes-components.clearFieldValue' })}
          ...
          <Button
            ...
            aria-label={formatMsg({ id: 'stripes-components.showOrHideDatepicker' })}
