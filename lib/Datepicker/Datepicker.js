...
class Datepicker extends React.Component {
  constructor(props) {
    ...
    this._dateFormat = this.props.dateFormat || moment.localeData()._longDateFormat.L;
  ...
  componentWillReceiveProps(nextProps){
    // if locale or dateFormat changes, update the _dateFormat variable.
    if(nextProps.dateFormat != this.props.dateFormat ||
      nextProps.locale != this.props.locale) {
        moment.locale(nextProps.locale);
        this._dateFormat = nextProps.dateFormat || moment.localeData()._longDateFormat.L; 
      }
  }
