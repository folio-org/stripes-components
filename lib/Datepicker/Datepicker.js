...
class Datepicker extends React.Component {
  constructor(props, context) {
    ...
    this.state = {
      date: initDate, // eslint-disable-line react/no-unused-state
  ...
  handleSetDate(e, date, stringDate) {
    if (e.type === 'click' || e.type === 'keydown') {
      ...
      this.setState({ dateString: stringDate, cursorDate: date, date }); // eslint-disable-line react/no-unused-state
    }
    if (e.type === 'change') {
      ...
      if (moment(tempString, this._dateFormat, true).isValid()) {
        ...
        this.setState({
          date: tempDate, // eslint-disable-line react/no-unused-state
          cursorDate: tempDate, // eslint-disable-line react/no-unused-state
  ...
  clearDate(e) {
    this.setState({
      date: undefined, // eslint-disable-line react/no-unused-state
      dateString: '',
    });
    if (this.props.onChange) { this.props.onChange(e); }
    if (this.props.input) {
