...
class Datepicker extends React.Component {
  ...
  constructor(props) {
    ...
    if (typeof this.props.input === 'undefined') {
      ...
      presentedValue = inputValue = moment(this.props.input.value, this._dateFormat)
        .tz(parseTimeZone)
    ...
    if (nextProps.input) {
      if (nextProps.input.value !== '' && nextProps.input.value !== prevState.input.value) {
        ...
        if (nextProps.input.value === prevState.passThroughValue || passRE.test(prevState.passThroughValue)) {
          ...
          presentedValue = inputValue = moment.tz(nextProps.input.value, prevState.parseTimeZone).format(_dateFormat);
        }
        return {
          presentedValue,
          dateString: inputValue,
