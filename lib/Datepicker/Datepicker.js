...
class Datepicker extends React.Component {
    ...
    if (this.picker) {
      ...
      switch (e.keyCode) {
        ...
        case 13: // enter
          ...
          dateString = this.props.intl.formatMessage({ id: 'stripes-components.dateSelected' }, { date: formattedDate });
          break;
        case 9: // tab
          this.hideCalendar();
          break;
  ...
  handleSetDate(e, date, stringDate) {
    if (e.type === 'click' || e.type === 'keydown') {
      ...
      this.textfield.current.refs.wrappedInstance.getInput().focus();
  ...
  render() {
    ...
    if (readOnly) {
      ...
      ariaLabel = formatMsg({ id: 'stripes-components.screenReaderLabel' }, { label, screenReaderFormat, screenReaderMessage });
    }
      ...
      endElement = (
        <div style={{ display: 'flex' }}>
          <Button
            ...
            title={formatMsg({ id: 'stripes-components.clearFieldValue' })}
          ...
          <Button
            ...
            title={formatMsg({ id: 'stripes-components.showOrHideDatepicker' })}
