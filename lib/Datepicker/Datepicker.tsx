...
const pickDataProps = (props) =>
  pick(props, (v, key) => key.indexOf("data-test") !== -1);
...
const Datepicker = ({
  ...
  maybeUpdateValue = (value) => {
    ...
    const backendStandard = getBackendDateStandard(
      backendDateStandard,
      outputBackendValue,
    );
  ...
  const renderCalendar = () => (
    <RootCloseWrapper onRootClose={handleRootClose} ref={pickerRef}>
      <Calendar
...
export default formField(injectIntl(Datepicker), ({ input, meta }) => ({
  onBlur: input?.onBlur,
