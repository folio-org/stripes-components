...
function Button(props) {
  ...
  if (props.href) {
    return (
      ...
      <AccessibleFocus component="a" className={getStyle()} onClick={handleAnchorClick} ref={getButtonRef} {...inputCustom}>
  ...
  return (
    <AccessibleFocus component="button" className={getStyle()} type={type} onClick={onClick} ref={getButtonRef} {...inputCustom}>
      <span className={css.buttonInner}>{children}</span>
    </AccessibleFocus>
  );
}
