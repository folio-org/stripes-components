...
type SpinnerEllipsisProps = { className?: string };
...
const SpinnerEllipsis = ({ className, ...rest }: SpinnerEllipsisProps) => (
  <div
    className={`${dotSpinner.spinner} ${className}`}
    {...omitProps(rest, ["viewBox"])}
  >
