  ...
  render() {
    ...
    switch (this.props.icon) {
      ...
      case 'right-double-chevron':
        ...
        break;
      case 'right-double-chevron-bold':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 26 26"><polygon style={style} className={className} points="10.7,24.25 15.301,24.25 23.3,13.073 15.4,1.75 10.7,1.75 10.7,1.75 18.601,13.073 " /><polygon style={style} className={className} points="2.7,24.25 7.4,24.25 15.301,13.073 7.4,1.75 2.7,1.75 2.7,1.75 10.7,13.073" /></svg>;
        break;
      case 'left-double-chevron-bold':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 26 26"><polygon style={style} className={className} points="7.399,13.073 15.3,1.75 15.3,1.75 10.6,1.75 2.7,13.073 10.699,24.25 15.3,24.25 " /><polygon style={style} className={className} points="15.3,13.073 23.3,1.75 23.3,1.75 18.6,1.75 10.699,13.073 18.6,24.25 23.3,24.25" /></svg>;
        break;
      case 'calendar':
      ...
      case 'spinner-ellipsis':
        iconHeight = parseInt(this.props.width, 10) / 2;
        iconSVG = (<div style={{ width: this.props.width, height: `${iconHeight}px` }} className={dotSpinner.spinner}>
      ...
      case 'validation-error':
        ...
        break;
      case 'trashBin':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 26 26"><path style={style} className={className} d="M23 8.5c0-0.6-0.4-1-1-1h-4.3V6.2c0-1.1-0.9-2-2-2h-5.5c-1.1 0-2 0.9-2 2v1.3H4c-0.6 0-1 0.4-1 1v1.4h2.3v9.6c0 1.9 1.3 3.4 3 3.4h9.1c1.7 0 3-1.5 3-3.4V9.9h2.6V8.5zM12.1 5.9h1.7c0.9 0 1.7 0.7 1.9 1.5h-5.6C10.4 6.6 11.2 5.9 12.1 5.9zM8.7 19v-9h1.5v9.1H8.7zM12 19v-9h1.5v9.1H12zM17 19h-1.5v-9h1.5V19z" /></svg>;
        break;
      case 'down-caret':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 26 26"><polygon style={style} className={className} points="13 20.6 1.8 7.3 4.1 5.4 13 15.9 21.9 5.4 24.2 7.3 " /></svg>;
        break;
      case 'up-caret':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 26 26"><polygon style={style} className={className} points="13 5.4 24.2 18.7 21.9 20.6 13 10.1 4.1 20.6 1.8 18.7 " /></svg>;
        break;
      case 'down-triangle':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 26 26"><polyline style={style} className={className} points="16.8 6.1 9 15.3 1.2 6.1 " /></svg>;
        break;
      case 'up-triangle':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 26 26"><polyline style={style} className={className} points="1.2 13.9 9 4.7 16.8 13.9 " /></svg>;
        break;
        case 'profile':
          iconSVG = <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 26 26" />;
          break;
      default:
        iconSVG = 'ICON';
    }
    ...
    return (
      <div
        ...
        style={{
          width: this.props.center ? '100%' : this.props.width,
          height: this.props.height || this.props.width,
          minWidth: this.props.width,
        }}
      >
        { (this.props.center) ?
          <div style={{ width: this.props.width, height: this.props.height }} tabIndex="-1">
            {(iconSVG)}
          </div> : iconSVG
        }
      </div>
