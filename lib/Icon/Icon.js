  ...
  render(){
    ...
    switch(this.props.icon){
      ...
      case 'plus-sign':
        ...
        break;
      case 'up-arrow':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26"><polygon style={style} className={className} points="24.2 12.8 13 1.6 1.8 12.8 3.9 15 11.5 7.4 11.5 22.3 14.5 22.3 14.5 7.4 22.1 15 " /></svg>;
        break;
      case 'down-arrow':
        iconSVG = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26"><polygon style={style} className={className} points="1.8 12.1 13 23.3 24.2 12.1 22.1 10 14.5 17.6 14.5 2.7 11.5 2.7 11.5 17.6 3.9 10 " /></svg>;
        break;
      default:
          iconSVG = "ICON";
    };
