...
describe.only('AuditLogPane', () => {
  ...
  describe('should display loading pane if references are loading', () => {
    ...
    it('should render current version as a button', () => Button('Current version').exists());
    it('should render an ordinary version as a button', () => Button('Changed').exists());
    it('should render original version', () => HTML('Original version').exists());
  });

  describe('when `showUserLink` prop is `false`', () => {
    beforeEach(async () => {
      await mountWithContext(
        <RenderAuditLogPane
          versions={mockVersions}
    ...
    it('should render current version as not a button', () => HTML('Current version').exists());
    it('should render an ordinary version as not a button', () => HTML('Changed').exists());
  });
});
