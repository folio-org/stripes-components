...
const AuditLogModal = ({
  ...
  const columnMapping = {
    action: <FormattedMessage id="stripes-components.versionHistory.modal.action" />,
    field: <FormattedMessage id="stripes-components.versionHistory.modal.field" />,
    changedFrom: <FormattedMessage id="stripes-components.versionHistory.modal.changedFrom" />,
    changedTo: <FormattedMessage id="stripes-components.versionHistory.modal.changedTo" />,
  };
