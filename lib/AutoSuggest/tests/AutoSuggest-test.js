...
// TODO: upstream to @folio/stripes-testing, then drop this override.
const AutoSuggestInteractor = Interactor.extend('auto-suggest (local)')
  .selector('[class^="downshift--"], [data-test-autosuggest]')
  .filters({
    open: (el) => el.querySelector('input').getAttribute('aria-expanded') === 'true',
  });
...
describe('AutoSuggest', () => {
  const autosuggest = AutoSuggestInteractor('autoSuggestTest');
