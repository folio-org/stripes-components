...
const AdvancedSearchModal = ({
  ...
  const modalTitle = intl.formatMessage({
    id: "stripes-components.advancedSearch.title",
  });

  const searchLabel = intl.formatMessage({
    id: "stripes-components.advancedSearch.footer.search",
  });
  const resetAllLabel = intl.formatMessage({
    id: "stripes-components.advancedSearch.footer.resetAll",
  });
  ...
  return (
    ...
    >
      <HotKeys keyMap={hotKeys} handlers={handlers} attach={shortcutsRef}>
        <div ref={shortcutsRef}>{children}</div>
      </HotKeys>
    </Modal>
  );
};
