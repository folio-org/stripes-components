...
function menuHandleKeyDown(e, open, disabled, onToggle, menuRef, triggerRef, onClose, focusLast, focusFirst) {
  if (disabled) {
    return;
  }
...
function triggerHandleKeyDown(e, open, disabled, onToggle, menuRef, onClose, focusLast) {
  if (disabled) {
    return;
  }
...
class Dropdown extends React.Component {
  constructor(props) {
    ...
    if (props.onSelectItem) {
      logWarning('The `onSelectItem` prop is deprecated.');
    }
  }
