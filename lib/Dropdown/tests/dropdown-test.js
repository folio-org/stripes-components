...
describe.only('Dropdown', () => {
  ...
  describe('basic functionality', () => {
    ...
    describe('clicking the trigger', () => {
      ...
      it('displays the dropdown menu', () => {
        ...
        expect(menuItem.isFocused).to.be.true;
      });
  ...
  describe('menu child API', () => {
    ...
    describe('clicking the trigger', () => {
      ...
      describe('clicking outside of the menu', () => {
        beforeEach(async () => {
          await dropdown.menu.items(0).blur();
        });
  ...
  describe.only('keyboard navigation', () => {
    ...
    describe('pressing down key from the trigger', () => {
      let focusTarget;
      beforeEach(async () => {
        focusTarget = getNextFocusable(document.activeElement);
        await dropdown.pressDownKey();
      });
      ...
      describe('pressing the down arrow', () => {
        ...
        describe('pressing the up arrow', () => {
          beforeEach(async () => {
            focusTarget = getPreviousFocusable(document.activeElement);
          ...
          describe('pressing the up arrow with first item focused', () => {
            beforeEach(async () => {
              ...
              focusTarget = getLastFocusable(dropdown.menu.$root);
            });
  ...
  describe('controlled functionality', () => {
    ...
    describe('clicking the trigger', () => {
      beforeEach(async () => {
        await dropdown.clickTrigger();
        await dropdown.when(() => dropdown.menu.items(0).isFocused);
      });
