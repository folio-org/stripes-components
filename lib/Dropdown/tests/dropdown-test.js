...
describe('Dropdown', () => {
  ...
  describe('renderTrigger and renderMenu props', () => {
    beforeEach(async () => {
      const trigger = ({ triggerRef, onToggle, ariaProps, keyHandler }) => (
        <Button autoFocus ref={triggerRef} onClick={onToggle} onKeyDown={keyHandler} {...ariaProps}>
          Trigger
        </Button>
      );
