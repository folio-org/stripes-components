...
describe('Dropdown', () => {
  ...
  describe('child function => object API', () => {
    ...
    it('displays the dropdown', async () => await dropdown.is({ visible: true }));

    it('initializes a closed dropdown', async () => await dropdown.is({ open: false }));

    it('initializes a hidden menu', async () => await ddmenu.is({ visible: false }));
  ...
  describe('menu-only render props API', () => {
    ...
    describe('clicking the trigger', () => {
      beforeEach(async () => await dropdown.toggle());
