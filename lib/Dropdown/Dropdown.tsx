...
function menuHandleKeyDown({ event: e, menuRef, onClose }) {
  let elem;
  switch (e.keyCode) {
    case 40: // down
      if (menuRef.current) {
...
class Dropdown extends React.Component<DropdownProps> {
  ...
  renderTrigger = () => {
    ...
    return ({ getTriggerProps }) => {
      return cloneElement(this.triggerChild, { ...getTriggerProps() });
    };
  };
  ...
  renderMenu = () => {
    ...
    return () => {
      return cloneElement(this.menuChild, { onClick: null, onKeyDown: null });
    };
  };
