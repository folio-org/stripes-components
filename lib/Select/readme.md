...
placeholder | string | Sets a disabled first option in the options list. The `value` prop must be an empty string `''` in order for this to appear in the control. |  | false
