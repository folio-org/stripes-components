...
class Select extends Component {
  ...
  render() {
    ...
    if (this.props.placeholder) {
      options.push(
        <option key="select-placeholder" value="" data-placeholder="true" disabled>{placeholder}</option>
      );
    }
    ...
    const component = (
      <select
        ...
        name={name}
        {...omitProps(selectCustom, ['className', 'selectClass', 'aria-labelledby', 'aria-label'])}
