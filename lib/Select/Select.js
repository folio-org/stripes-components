...
class Select extends React.Component{
  ...
  render(){
    ...
    const {label, placeholder, dataOptions, children, fullWidth, ...selectCustom} = {...rest};
    
    let options = [];
    
    this.props.placeholder? options.push(<option value="placeholder" disabled >{placeholder}</option>):null;
