...
import { Select as Interactor, runAxeTest } from '@folio/stripes-testing';
...
describe('Select', () => {
  ...
  describe('rendering a basic Select', async () => {
    ...
    it('contains no axe errors - Select', runAxeTest);
  ...
  describe('supplying label and id', () => {
    ...
    it('contains no axe errors - Select - label', runAxeTest);
  });

  describe('supplying an error', () => {
    beforeEach(async () => {
      await mount(
        <Select label="test error label" error="This is an error." />
      );
    });

    it('renders an error element', () => select.has({ error: 'This is an error.' }));
    it('is labeled as invalid', () => select.is({ valid: false }));
    it('contains no axe errors - Select: error validation', runAxeTest);
  });
  ...
  describe('Passing aria-labelledby prop', () => {
    beforeEach(async () => {
      await mount(
        <>
          <div id="testlabel">testlabel</div>
    ...
    it('contains no axe errors - Select: aria-labelledby', runAxeTest);
  });
