...
describe.only('AutoComplete', () => {
  ...
  describe('renders AutoComplete with list', () => {
    ...
    describe('Fill and blur the input', () => {
      beforeEach(async () => {
        await autoComplete.textfield.fillAndBlur(inputTerm);
      });
    ...
    describe('Fill the input', () => {
      beforeEach(async () => {
        await autoComplete.textfield.fillInput(inputTerm);
      });
  ...
  describe('rendering autoComplete items list', () => {
    ...
    it(`renders with a list of ${expectedItems.length} items`, () => {
      expect(autoComplete.options().length).to.equal(expectedItems.length);
    });
  ...
  describe('Keyboard: Enter press', () => {
    ...
    describe('fill input', () => {
      ...
      describe('keyboard enter', () => {
        ...
        it('selects the first list item', () => {
          expect(autoComplete.textfield.val).to.equal(inputTerm);
        });
      });
    });
  });
