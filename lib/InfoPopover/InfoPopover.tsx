...
const InfoPopover = ({
  ...
  const getContentClass = () => classnames(css.content, contentClass);
  ...
  const renderContent = (
    { toggle } /* eslint-disable-line react/prop-types */,
  ) => (
    <>
      <div data-test-info-popover-content className={getContentClass()}>
        {content}
      </div>
      {buttonHref && (
        <Button
