      ...
      return (
        <div style={{ display: 'flex' }}>
          <Button
            ...
            title={formatMsg({ id: 'stripes-components.saveChangesToThisItem' })}
          ...
          <Button
            ...
            title={formatMsg({ id: 'stripes-components.cancelEditingThisItem' })}
      ...
      <div style={{ display: 'flex' }}>
        {!actionSuppression.edit(item) &&
          <IconButton
            ...
            title={formatMsg({ id: 'stripes-components.editThisItem' })}
        ...
        {!actionSuppression.delete(item) &&
          <IconButton
            ...
            title={formatMsg({ id: 'stripes-components.deleteThisItem' })}
...
EditableListForm.contextTypes = contextTypes;
