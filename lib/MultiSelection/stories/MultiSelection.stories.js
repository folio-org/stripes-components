...
import LargeOptionList from './LargeOptionList';
...
export const _LargeOptionList = () => <LargeOptionList />;
_LargeOptionList.storyName = 'Large option list (content-visibility)';
