...
class MultiSelection extends React.Component {
  ...
  constructor(props) {
    ...
    this.atSmallMedia = window.matchMedia('(max-width: 800px)').matches;
  }
        ...
        >
          {({
            ...
            const optionListProps = {
              ...
              error,
              warning,
              atSmallMedia: this.atSmallMedia,
                  ...
                  <div className={css.multiSelectControlGroup}>
                    ...
                    { !this.atSmallMedia && 
                      ...
                      {...getInputProps({
                        ...
                        ref: this.input,
                        onKeyDown: (event) => {
                          this.handleInputKeyDown(event, removeItem, selectedItems, setHighlightedIndex, changeCallback);
                        },
