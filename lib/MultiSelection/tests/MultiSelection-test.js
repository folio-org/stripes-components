  ...
  describe('clicking the control', () => {
    ...
    describe('clicking multiple options', () => {
      ...
      describe('Keyboard: Backspace to remove values', () => {
        ...
        it('calls the supplied onRemove handler, supplying the removed item.', () => converge(() => onRemove.calledOnceWith(listOptions[4].label)));
        ...
        describe('Clicking the remove button on the first value chip', () => {
          ...
          it('calls the supplied onRemove handler, supplying the removed item.', () => converge(() => onRemove.calledOnceWith(listOptions[2].label)));
        });
        ...
        describe('Clicking the remove button on the first value chip', () => {
          ...
          it('calls the supplied onRemove handler, supplying the removed item.', () => converge(() => onRemove.calledOnceWith(listOptions[3].label)));
        });
      });
    });
