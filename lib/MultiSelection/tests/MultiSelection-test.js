...
describe('MultiSelect', () => {
  ...
  describe('clicking the control', () => {
    ...
    describe('clicking an option', () => {
      ...
      it('sets correct hidden input value', () => {
        expect(multiselection.inputValue).to.equal(listOptions[2].value);
      });
    });
  ...
  describe('MultiSelection, initial value', () => {
    ...
    it('sets correct value in hidden input', () => {
      expect(multiselection.inputValue).to.equal(`${listOptions[1].value},${listOptions[3].value},${listOptions[5].value}`);
    });
