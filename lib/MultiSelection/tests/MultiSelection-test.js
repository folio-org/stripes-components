...
describe.only('MultiSelect', () => {
  ...
  it('contains no axe errors - Multiselect', async () => runAxeTest());
  ...
  describe('clicking the control', () => {
    ...
    it('contains no axe errors - Multiselect: open menu', async () => runAxeTest());
  ...
  describe('Filtering option list: cursor on first', () => {
    ...
    describe('Supplied an \'error\' prop', () => {
      ...
      it('contains no axe errors  - Multiselect: error validation', async () => runAxeTest());
