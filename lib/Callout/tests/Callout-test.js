...
describe('Callout', () => {
  ...
  describe('dedupe functionality', () => {
    ...
    describe('when message is an object', () => {
      beforeEach(async () => {
        dedupeRef.current.sendCallout({ message: <span id="same-id">Object message</span>, timeout: 999999, type: 'success', dedupe: true });
        dedupeRef.current.sendCallout({ message: <span id="same-id">Object message</span>, timeout: 999999, type: 'success', dedupe: true });
        dedupeRef.current.sendCallout({ message: <span id="different-id">Object message</span>, timeout: 999999, type: 'success', dedupe: true });
      });
