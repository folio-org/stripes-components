...
const propTypes = {
  ...
  /*
   * Whether or not the component should display the Heading(includes label and 'Add Address' action)
   */
...
class AddressList extends React.Component {
  ...
  render() {
    const { addresses, uniqueField, sectionLabel, canDelete, canEdit, headerFormatter, displayHeading, ...viewProps } = this.props;
