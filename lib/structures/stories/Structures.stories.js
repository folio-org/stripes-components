...
import ConfirmationModalUsage from '../ConfirmationModal/stories/BasicUsage';
...
storiesOf('structures', module)
  ...
  .add('ConfirmationModal', withReadme(ConfirmationModalReadme, () => <ConfirmationModalUsage />))
