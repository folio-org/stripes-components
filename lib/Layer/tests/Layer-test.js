...
import { Layer as Interactor, Button as ButtonInteractor, HTML as HTMLInteractor, runAxeTest } from '@folio/stripes-testing';
...
describe('Layer', () => {
  ...
  describe('opening the layer', () => {
    ...
    it('shows the layer and content', async () => {
      ...
      await HTMLInteractor({ id: 'layerTestContent' }).exists();
    });
    ...
    it('should have no axe errors - Layer (open)', runAxeTest);
    ...
    describe('closing the layer', () => {
      ...
      it('hides the layer and content', async () => {
        await layer.absent();
        await HTMLInteractor({ id: 'layerTestContent' }).absent();
      });
