...
class RadioButton extends React.Component {
  ...
  render() {
    ...
    const inputId = id || uniqueId('radio-button-');
    ...
    return (
      <div className={this.getRootStyle()}>
        ...
        <AccessibleFocus boxOffsetStart="small" boxOffsetEnd="small" component="label" htmlFor={inputId} className={this.getLabelStyle()} {...this.props.accessibleFocusProps}>
