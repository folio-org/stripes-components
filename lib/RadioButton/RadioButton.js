  ...
  render() {
    ...
    return (
      <div className={this.getRootStyle()}>
        ...
        <AccessibleFocus boxOffsetStart="small" boxOffsetEnd="small" component="label" htmlFor={this.inputId} className={this.getLabelStyle()} {...this.props.accessibleFocusProps}>
