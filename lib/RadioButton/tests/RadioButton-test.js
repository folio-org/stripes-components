...
import { RadioButton as Interactor, runAxeTest } from '@folio/stripes-testing';
...
describe('RadioButton', () => {
  ...
  describe('with an id', () => {
    ...
    beforeEach(async () => {
      await mount(
        <RadioButton label="test checkbox" id="checkbox-test" />
      );
    });

    it('has an id on the input element', () => radioButtonId.has({ id: 'checkbox-test' }));

    it('contains no axe errors - RadioButton', runAxeTest);
  });
