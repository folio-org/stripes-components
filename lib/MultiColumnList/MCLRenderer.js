  ...
  */
  renderRows() {
    ...
    if (virtualize && height) {
      bodyExtent = height + scrollTop + maxScrollDelta * 2;
    } else if (this.scrollContainer.current && virtualize) {
      bodyExtent = this.scrollContainer.current.offsetHeight + maxScrollDelta * 2;
    } else if (!virtualize && this.rowContainer.current) {
      bodyExtent = this.rowContainer.current.offsetHeight + maxScrollDelta * 2;
    } else {
      bodyExtent = 500 + maxScrollDelta * 2;
    }
