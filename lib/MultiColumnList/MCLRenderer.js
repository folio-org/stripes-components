...
class MCLRenderer extends React.Component {
  ...
  renderCells = (rowIndex) => {
    ...
    const getCellClasses = (defaultClass) => `${defaultClass} ${css.mclEditableCell}`;
    const setCellClasses = this.props.getCellClasses ? getCellClasses(css.mclCellStyle) : css.mclCellStyle;
      ...
      cells.push((
        ...
        >
          <div
            ...
            className={`${css.mclCell} ${showOverflow} ${setCellClasses}`}
            style={cellStyle}
          >
            {value}
          </div>
