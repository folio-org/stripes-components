  ...
  renderRows = () => {
    ...
    */
    ...
    for (
      ...
      // ((currentTop <= bodyExtent) && (rowIndex < limit));
      ...
      if (contentData[rowIndex]) {
        rows.push(
          /* RowPositioner is a PureComponent - this brings maximum efficiency at the cost of making it aware
            of any side effects that could cause a difference in the rendered output - components/functions within formatters
            that depend on data outside of the contentData itself.
          */
          <RowPositioner
