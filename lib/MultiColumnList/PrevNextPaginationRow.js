      ...
      {({ localRowIndex, position }) => (
        ...
        >
          <FormattedMessage id="stripes-components.mcl.itemsRequestedMessage">
            { ([message]) => (
                <div style={{ width: `${(width || prevWidth) - scrollBarWidth}px`, position: 'sticky', left: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'space-around', marginBottom: '1rem'}}>
                  ...
                  />
                  <div style={{fontWeight: 'bold', display: 'flex', flexGrow: 3, flexShrink: 0, flexBasis: '45%', alignItems: 'center', justifyContent: 'center', alignContent: 'middle'}}>
