...
describe('MultiColumnList', () => {
  ...
  describe('rendering with empty starting data', () => {
    beforeEach(async () => {
      await mountWithContext(<MCLHarness key="1" initialData={[]} autosize={false} columnWidths={{'name': '200px'}} />);
    });
  ...
  describe('detecting data changes', function() {
    let currentData;
    let nextData;
