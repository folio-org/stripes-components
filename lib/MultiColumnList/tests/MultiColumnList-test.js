...
describe('MultiColumnList', () => {
  ...
  describe('column width ranges', () => {
    ...
    it.skip('has no axe errors', runAxeTest);
  ...
  describe('using the "onHeaderClick" prop ', () => {
    ...
    it.skip('clickable headers - no axe errors', runAxeTest);
  ...
  describe('using the pagingType prop', () => {
    ...
    it.skip('click paging type has no axe errors', runAxeTest);
  ...
  describe('prev-next paging', () => {
    ...
    it.skip('prev-next paging has no axe errors', runAxeTest);
