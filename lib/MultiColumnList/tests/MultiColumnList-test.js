...
describe.only('MultiColumnList', () => {
  ...
  describe('using the pagingType prop', () => {
    ...
    it('renders the paging button', () => ButtonInteractor('Load more').is({ visible: true }));
    ...
    describe('clicking the paging button', () => {
      ...
      it('calls the onNeedMoreData handler', () => {
        expect(pagingNeedMore.calledWith(30, 3)).to.be.true;
      });
    });
  });
  ...
  describe('prev-next paging', () => {
    ...
    beforeEach(async () => {
      ...
      // await ButtonInteractor('Next').click();
    });
    ...
    describe('paging previous', () => {
      beforeEach(async () => {
        ...
        // await ButtonInteractor('Previous').click();
      });
