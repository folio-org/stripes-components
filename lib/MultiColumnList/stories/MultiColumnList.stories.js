...
import UseCSSGrid from './UseCSSGrid';

export default {
  title: 'Components/MultiColumnList',
};
...
export const _ContentVisibility = () => <ContentVisibility />;
_ContentVisibility.storyName = 'Content Visibility (experimental)';

export const _UseCSSGrid = () => <UseCSSGrid />;
_UseCSSGrid.storyName = 'UseCSSGrid';
