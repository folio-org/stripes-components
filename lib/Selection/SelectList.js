...
class SelectList extends React.Component {
  ...
  getClass(o) {
    // selected class..
    const selectCriteria = o.value === this.props.selected;
  ...
  getActionIndicator(o) {
    ...
    return selectCriteria ? (
      <FormattedMessage id="stripes-components.removeSelection">
        {ariaLabel => (
          <span role="img" aria-label={ariaLabel}>&#x2796;</span>
        )}
      </FormattedMessage>
    ) : (
      <FormattedMessage id="stripes-components.addSelection">
        {ariaLabel => (
          <span role="img" aria-label={ariaLabel}>&#x271A;</span>
        )}
      </FormattedMessage>
