...
class MultiSelect extends React.Component {
  ...
  getEndControl() {
    if (this.state.selectedList.length > 0) {
      return (<IconButton icon="closeX" type="button" className={css.SelectionClearAll} size="small" title="clear all values" onClick={this.clearAllSelected} />);
    }
