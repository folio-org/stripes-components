...
describe.only('Selection, Single select', () => {
  ...
  describe('legacy rendering (tether prop)', () => {
    const tetherSelect = SelectionInteractor('tether selection');
  ...
  describe('Selection, initial value', () => {
    ...
    describe('Filtering option list: cursor on first', () => {
      ...
      it.only('sets cursor to first result', () => {
        SelectionOptionInteractor.has({ className: including('cursor'), index: 0 });
      });
