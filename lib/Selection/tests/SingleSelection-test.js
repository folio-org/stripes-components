...
describe('Selection, Single select', () => {
  ...
  it('contains no axe errors - Selection', runAxeTest);
  ...
  describe('supplying a label prop', () => {
    ...
    it('contains no axe errors - Selection: Label', runAxeTest);
  });
  ...
  describe('clicking the control', () => {
    ...
    it('contains no axe errors - Selection: open menu', runAxeTest);
    ...
    it('filter input is rendered with "combobox" role', () => {
      expect(selection.filterRole).to.equal('combobox');
    });
    ...
    it('contains no axe errors - Selection: toggling the menu', runAxeTest);
    ...
    describe('filtering options', () => {
      ...
      it('does not display the empty message', () => {
        expect(selection.alertMessage.isPresent).to.be.false;
      });
      ...
      describe('No options available after filtering', () => {
        ...
        it('displays the empty message', () => {
          expect(selection.alertMessage.isPresent).to.be.true;
        });
      });
    });
  });
