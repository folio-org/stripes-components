...
class SingleSelect extends React.Component {
  ...
  filterList(e) {
    const { dataOptions, intl: { formatMessage }, onFilter } = this.props;
  ...
  render() {
    const { intl: { formatMessage }, tether } = this.props;
    ...
    const selectList = (
      <SelectList
        ...
        emptyMessage={this.props.emptyMessage ||
          formatMessage({ id: 'stripes-components.selection.noMatches' })
        }
