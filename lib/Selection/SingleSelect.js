  ...
  filterHandleKeyDown(e) {
    ...
    switch (e.keyCode) {
      ...
      case 9: // tab
        ...
        // if listbox's filter field is focused (single selection), refocus the main control (focus should shift to the next focusable item)
      ...
      >
        ...
        <div className={css.SelectionControlContainer} >
          ...
          <button
            ...
            aria-owns={`sl-${this.testId} ${this.testId}-selected-items-list sl-container-${this.testId}`}
