...
class SingleSelect extends React.Component {
  constructor(props) {
    ...
    this.setFilterTextInputRef = this.setFilterTextInputRef.bind(this);
  ...
  setFilterTextInputRef(elem) {
    ...
    this.filterTextInput.current = elem;
  }
  ...
  render() {
    const { tether, required, popper: popperProps } = this.props;
    ...
    const selectList = (
      <SelectList
        ...
        innerRef={this.setFilterTextInputRef}
