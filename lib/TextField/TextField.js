...
class TextField extends Component {
  ...
  render() {
    ...
    if (this.props.hasClearIcon
      ...
      clearField = (
        <TextFieldIcon
          ariaLabel={formatMessage({ id: 'stripes-components.clearThisField' })}
          icon="clearX"
    ...
    if (this.props.validStylesEnabled
      ...
      validation = (
        <TextFieldIcon
          ariaLabel={formatMessage({ id: 'stripes-components.fieldIsValid' })}
    ...
    if (validationEnabled && this.props.error) {
      validation = (
        <TextFieldIcon
          ariaLabel={formatMessage({ id: 'stripes-components.fieldHasError' })}
    ...
    if (this.props.loading) {
      validation = (
        <TextFieldIcon
          ariaLabel={formatMessage({ id: 'stripes-components.validatingInProcess' })}
