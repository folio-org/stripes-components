...
class TextField extends React.Component {
  ...
  render() {
    ...
    const inputCustom = omitProps(cleanedProps, ['label', 'endControl', 'startControl', 'rounded', 'required', 'fullWidth', 'marginBottom0', 'noBorder', 'validationEnabled', 'meta', 'inputClass', 'hasClearIcon', 'ariaLabel']);
    const component = (
      <input
    ...
    if (this.props.meta) {
      ...
      if (this.props.meta.touched && !this.props.meta.active && !this.props.meta.valid && !this.props.meta.asyncValidating) {
        if (this.input && (this.input.value === '' || !this.input.value)) {
          ...
          clearField = this.props.hasClearIcon && <TextFieldIcon title="Clear this field" onClick={this.clearField} icon="clearX" />;
        }
      }
      if (this.props.hasClearIcon && this.props.meta.active && this.props.input.value !== '') {
