...
class TextField extends React.Component {
  ...
  render() {
    ...
    const endControlElement = <div className={css.endControls}><div className={css.controlGroup} ref={ref => this.endControl = ref}>{clearField}{validation}{endControl}</div></div>;
