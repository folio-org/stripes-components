...
class TextField extends React.Component {
  ...
  render() {
    ...
    const inputCustom = omitProps(cleanedProps, ['label', 'endControl', 'startControl', 'required', 'fullWidth', 'marginBottom0', 'noBorder', 'validationEnabled', 'meta', 'inputClass', 'hasClearIcon', 'ariaLabel', 'onClearField', 'clearFieldId']);
    const component = (
      <input
