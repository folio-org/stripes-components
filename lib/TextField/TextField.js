...
class TextField extends React.Component {
  ...
  render() {
    ...
    const inputCustom = omitProps(cleanedProps, ['label', 'endControl', 'startControl', 'required', 'fullWidth', 'marginBottom0', 'noBorder', 'validationEnabled', 'meta', 'inputClass', 'hasClearIcon', 'ariaLabel', 'onClearField', 'clearFieldId', 'validStylesEnabled']);
    const component = (
      <input
    ...
    if (this.props.meta) {
      ...
      // This is disabled by default because it's primarily used when someting is
