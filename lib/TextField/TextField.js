...
class TextField extends React.Component {
  ...
  getInputStyle() {
    ...
    return classNames(
      ...
      { [`${formStyles.marginBottom0}`]: this.props.marginBottom0 },
      validationClasses,
    );
  }
    ...
    if (this.props.meta) {
      ...
      if (this.props.meta.touched && !this.props.meta.active && !this.props.meta.valid && !this.props.meta.asyncValidating) {
        if (this.input && (this.input.value === '' || !this.input.value)) {
          ...
          clearField = <TextFieldIcon title="Clear this field 1 " onClick={this.clearField} icon="clearX" />;
        }
      }
      if (this.props.meta.active && this.props.input.value !== '') {
        clearField = <TextFieldIcon title="Clear this field 2" onMouseDown={this.clearField} tabIndex="-1" icon="clearX" />;
      }
    }
