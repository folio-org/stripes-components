...
class TextField extends React.Component {
  ...
  render() {
    ...
    const inputCustom = omitProps(cleanedProps, ['label', 'endControl', 'startControl', 'rounded', 'required', 'fullWidth', 'marginBottom0', 'noBorder', 'validationEnabled', 'meta', 'inputClass', 'hasClearIcon']);
    const component = (
      <input
