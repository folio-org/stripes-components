...
class Accordion extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    // if using state...
    if (typeof this.state.isOpen === 'boolean') {
    ...
    if (this.props.id === 'instanceAccordion') {
      console.debug('prevState.isOpen:', prevState.isOpen, 'this.state.isOpen:', this.state.isOpen, 'prevProps.open:', prevProps.open, 'this.props.open:', this.props.open);
    }
