...
class AccordionSet extends React.Component {
  ...
  focusFirstAccordion() {
    if(this.state.accordionList[0]) {
      this.state.accordionList[0].getRef().focus();
    } else {
      setTimeout(() => this.state.accordionList[0].getRef().focus());
    }
  }

  focusLastAccordion() {
    if(this.state.accordionList[this.state.accordionList.length - 1]) {
      this.state.accordionList[this.state.accordionList.length - 1].getRef().focus();
    } else {
      setTimeout(() => this.state.accordionList[this.state.accordionList.length - 1].getRef().focus());
    }
  }
