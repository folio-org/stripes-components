...
const Focused = Button.extend('Accordion header')
  ...
  .actions({
    pressKey: async ({ perform }, key) => {
      await perform(() =>  Keyboard.pressKey(key))
    }
  });
...
describe('Accordion', () => {
  ...
  describe.only('as part of an AccordionSet', () => {
    ...
    beforeEach(async () => {
      await mountWithContext(
        <AccordionSet>
          <Accordion label="test1">
            <input aria-label="test1" />
          </Accordion>
          <Accordion label="test2">
            <input aria-label="test2" />
          </Accordion>
          <Accordion label="test3">
            <input aria-label="test3" />
          </Accordion>
          <Accordion label="test4">
