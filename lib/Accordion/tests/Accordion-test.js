...
import { Accordion as Interactor, Keyboard, converge, runAxeTest } from '@folio/stripes-testing';
...
describe('Accordion', () => {
  ...
  describe('clicking the header', () => {
    ...
    it('clooooses the accordion', () => accordion.is({ open: false }));

    it('calls onClickToggle with correct "open" state', async () => {
      converge(() => expect(onClickToggleSpy.calledWith({
        id: 'test-id',
        label: 'test',
        open: false,
      })).to.be.true);
  ...
  describe('with an id', () => {
    ...
    it('has an id on the root element', () => converge(() => accordion.has({ id: 'accordion-test' })));
  ...
  describe('with a content id', () => {
    ...
    it('has an id on the accordion-wrapper element', () => converge(() => accordion.has({ contentId: 'content-test' })));
  });
