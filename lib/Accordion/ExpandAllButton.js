...
const ExpandAllButton = (props) => {
  let expanded = 0;
  let collapsed = 0;
  const expandLabel = props.expandLabel ? props.expandLabel : <FormattedMessage id="stripes-components.expandAll" />;
  const collapseLabel = props.collapseLabel ? props.collapseLabel : <FormattedMessage id="stripes-components.collapseAll" />;
