...
type DateRangeWrapperProps = {
  ...
  endExcluder?: (...args: any[]) => any;
  endValueGetter?: (...args: any[]) => any;
  initialEndDate?: Record<string, any> | string;
  initialStartDate?: Record<string, any> | string;
  startExcluder?: (...args: any[]) => any;
  startValueGetter?: (...args: any[]) => any;
};
...
class DateRangeWrapper extends React.Component<DateRangeWrapperProps> {
  static defaultProps = {
