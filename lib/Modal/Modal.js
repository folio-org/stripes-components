...
import ModalFooter from '@folio/stripes-components/lib/ModalFooter'; /* eslint-disable-line import/no-extraneous-dependencies */
...
const propTypes = {
  ...
  footer: PropTypes.oneOfType([
    PropTypes.node,
    PropTypes.instanceOf(ModalFooter)
  ]),
