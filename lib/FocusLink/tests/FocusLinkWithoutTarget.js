...
describe('FocusLink', () => {
  ...
  describe('Press on the Enter button', () => {
    ...
    it('should make the target focused', () => converge(() => focusSpy?.called));
  });
});
...
describe('FocusLink with targetNextAfter prop', () => {
  ...
  describe('Clicking on focus link', () => {
    ...
    it('should make the target focused', () => converge(() => { if (!focusSpy.called) throw (new Error('target not focused')); }));
  });
});
