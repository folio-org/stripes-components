...
const IconButton = ({ icon, onClick, onMouseDown, title, type, ariaLabel, id, style, className, badgeCount, iconClassName, tabIndex, badgeColor, href, ...rest }) => {
  let Element = 'button';
  ...
  let buttonProps = {
    ...
    tabIndex,
    ...rest,
    className: classNames(css.iconButton, { [css.hasBadge]: badgeCount }, className),
