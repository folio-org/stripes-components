...
const IconButton = ({ icon, onClick, onMouseDown, title, ariaLabel, id, style, className, badgeCount, iconClassName, size, tabIndex }) => (
  <button onMouseDown={onMouseDown} tabIndex={tabIndex} className={classNames(css.iconButton, className, size)} title={title} onClick={onClick} aria-label={ariaLabel} id={id} style={style}>
