...
import addFocusListener from './addFocusListener.js';
import addFocusOutListener from './addFocusOutListener.js';
...
const HotKeys = createReactClass({
  ...
  componentDidMount() {
    ...
    this.__mousetrap__ = new Mousetrap(
      this.props.attach || comp
    );

    comp.setAttribute('tabindex', this.props.tabIndex);
    this.onFocusListener = addFocusListener(comp, this.onFocus);
    this.onFocusOutListener = addFocusOutListener(comp, this.onBlur);
