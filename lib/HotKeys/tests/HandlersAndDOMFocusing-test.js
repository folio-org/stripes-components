...
describe('Activating hotkeys by focusing in the DOM:', () => {
  ...
  describe('when a contained element is auto-focused', () => {
    let handler;
      ...
      await mount(
        <div>
          <HotKeys keyMap={keyMap} handlers={handlers} attach={el}>
            <input autoFocus aria-label="childElement" ref={el} />
          </HotKeys>
        </div>
      );
    });
    ...
    beforeEach(async () => {
      ...
      await mount(
        <HotKeys keyMap={keyMap} attach={wrapperRef}>
          <div ref={wrapperRef}>
            <HotKeys handlers={outerHandlers} id="outer" attach={outerRef}>
              <div ref={outerRef}>
                <input aria-label="outerElement" />
                <HotKeys handlers={innerHandlers} id="inner" attach={innerRef}>
