  ...
  render(){
    return(
      <div className={css.headerSearchContainer}>
        ...
        <input className={css.headerSearchInput} type="text" role="search" aria-label={this.props.searchAriaLabel} value = {this.props.value} onChange={this.props.onChange} placeholder="Search"/>
        <Button className={css.headerSearchClearButton} onClick={this.props.onClear} aria-label="Clear search field"><Icon icon="clearX" iconClassName={css.clearIcon}/></Button>
