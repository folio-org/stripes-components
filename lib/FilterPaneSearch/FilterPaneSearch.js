...
const FilterPaneSearch = props => (
  <div className={css.headerSearchContainer}>
    ...
    <input className={css.headerSearchInput} type="text" id={props.searchFieldId} role="search" aria-label={props.searchAriaLabel} value={props.value} onChange={props.onChange} placeholder={props.placeholder || "Search"} />
