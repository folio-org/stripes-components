...
class AccessibleFocus extends Component {
  render() {
    const { children, component, className, wrap, flex, focusDot, focusDotPosition, focusDotOffset, boxOffset, boxOffsetStart, boxOffsetEnd, boxOffsetTop, boxOffsetBottom, ...rest } = this.props;
