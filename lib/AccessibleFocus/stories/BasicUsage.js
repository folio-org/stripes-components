...
const SimpleButton = props => <button style={{ marginRight: '15px', padding: '30px 30px', minWidth: '220px', outline: 0, backgroundColor: '#f7f7f7' }} {...props}>{props.children}</button>; // eslint-disable-line react/prop-types

export default () => (
  <div style={{ padding: '15px' }}>
    <Headline>A simple focusable button</Headline>
    <AccessibleFocus component={SimpleButton}>
