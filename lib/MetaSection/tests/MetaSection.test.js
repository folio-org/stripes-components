...
import LocalInteractor from './interactor';
...
describe('MetaSection', () => {
  ...
  describe('When useAccordion false', () => {
    const metaSectionWOAccordion = new LocalInteractor();
    ...
    describe('If no update details are provided', () => {
      ...
      it('Should render "Unknown user" updated-by field', () => {
        expect(metaSectionWOAccordion.updatedByText).to.contain('Unknown user');
      });
    });
    ...
    describe('when update details are provided', () => {
      ...
      it('Should render updated-by field', () => {
        expect(metaSectionWOAccordion.updatedByText).to.contain('Opus');
      });

      it('Should render not render created by details', () => {
        expect(metaSectionWOAccordion.createdByText).to.be(undefined);
      });
    })
  })
});
