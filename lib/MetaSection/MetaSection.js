    ...
    return (
      <div className={css.metaSectionRoot}>
        <Accordion
          ...
          label={<FormattedMessage id="stripes-components.metaSection.recordLastUpdated" values={{ date: this.formatDate(lastUpdatedDate), time: this.formatTime(lastUpdatedDate) }} />}
        >
          <div className={css.metaSectionContent}>
            {lastUpdatedBy &&
              <div className={css.metaSectionContentBlock}>
                <FormattedMessage id="stripes-components.metaSection.source" values={{ source: lastUpdatedBy }} />
              </div>
            }
            { (createdDate || createdBy) && (
              <div className={css.metaSectionGroup}>
                {createdDate &&
                  <div className={css.metaSectionContentBlock}>
                    <FormattedMessage id="stripes-components.metaSection.recordCreated" values={{ date: this.formatDate(createdDate), time: this.formatTime(createdDate) }} />
                  </div>
                }
                {createdBy &&
                  <div className={css.metaSectionContentBlock}>
                    <FormattedMessage id="stripes-components.metaSection.source" values={{ source: createdBy }} />
                  </div>
                }
              </div>
            )}
