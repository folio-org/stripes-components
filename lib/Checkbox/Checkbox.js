  ...
  render() {
    ...
    return (
      <div className={this.getRootStyle()}>
        ...
        />
        <AccessibleFocus boxOffsetStart={label ? 'small' : undefined} boxOffsetEnd={label ? 'small' : undefined} component="label" role="button" className={this.getLabelStyle()} htmlFor={this.inputId} {...this.props.accessibleFocusProps}>
