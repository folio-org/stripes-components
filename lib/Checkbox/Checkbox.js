      ...
      <div className={this.getRootStyle()}>
        <label className={this.getLabelStyle()}>
          ...
          <span className={css.labelCheck}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="M10.395 4.617L5.63 9.383 3.605 7.358" /></svg>
          </span>
