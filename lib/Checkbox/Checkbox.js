...
class Checkbox extends React.Component {
  ...
  render() {
    ...
    const inputId = this.props.id ? this.props.id : `checkbox-${uniqueId()}`;
    ...
    return (
      <div className={this.getRootStyle()}>
        ...
        />
        <AccessibleFocus boxOffsetStart={label ? 'small' : undefined} boxOffsetEnd={label ? 'small' : undefined} component="label" role="button" className={this.getLabelStyle()} htmlFor={inputId} {...this.props.accessibleFocusProps}>
