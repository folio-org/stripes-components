...
import { Checkbox as Interactor, converge, runAxeTest } from '@folio/stripes-testing';
...
describe('Checkbox', () => {
  describe('render a checkbox', () => {
    ...
    it('has no axe errors - Checkbox', runAxeTest);
  ...
  describe('with a value', () => {
    ...
    describe('clicking the label', () => {
      ...
      it('displays the input as checked', () => {
        converge(() => checkbox.is({ checked: true }));
      });
    });
  });
  ...
  describe('if a createRef() is passed to the inputRef-prop', () => {
    ...
    it('should return a valid ref', () => {
      converge(() => expect(ref.current).to.not.be.null);
    });
  });
  ...
  describe('if a function is passed to the inputRef-prop', () => {
    ...
    it('should pass an HTML input element as a parameter to the passed function', () => {
      converge(() => expect(element.constructor.name).to.equal('HTMLInputElement'));
    });
  });
