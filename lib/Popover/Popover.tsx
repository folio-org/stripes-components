...
const isLegacy = (childrenProp) => {
  return (
    ...
    get(React.Children.toArray(childrenProp), "[0].props[data-role]") ===
      "target"
  );
};
...
const Popover = forwardRef(
  (
    ...
    const handleToggle =
      typeof onToggle === "function" ? onToggle : () => internalToggleRef();
    const modifiers = {
      offset: { enabled: true, offset: `0,${offset}` },
      ...modifiersProp,
    };
...
const PopoverWithLegacySupport = (props) => {
